    ...
    >
      <div className="flex flex-col items-center w-full max-w-7xl mx-auto text-center">
        <div
          ...
          className="text-3xl sm:text-5xl font-extrabold leading-6 sm:leading-10"
        >
          {highlight_title}
        </div>
        <div
          ...
          className="mt-2 text-3xl font-extrabold leading-6 sm:leading-10 text-opacity-70"
        >
          {highlight_description}
        </div>
        <a
          ...
          className="mt-4 px-12 rounded-full p-4 text-sm uppercase"
          target="_blank"
        >
          {highlight_button_label}
        </a>
